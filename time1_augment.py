...
class ClimateEmulationDataModule(LightningDataModule):
    ...
    def setup(self, stage: str | None = None):
        ...
        self.train_dataset = ClimateDataset(train_input_norm_dask, train_output_norm_dask, train_months, output_is_normalized=True)
        self.val_dataset = ClimateDataset(val_input_norm_dask, val_output_norm_dask, val_months_list, output_is_normalized=True)
        self.test_dataset = ClimateDataset(test_input_norm_dask, test_output_raw_dask, test_months_list, output_is_normalized=False)
